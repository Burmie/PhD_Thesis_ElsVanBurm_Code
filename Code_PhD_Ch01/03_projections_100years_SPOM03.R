...
simulate_metapopulation_dynamics_100years <- function (run_name){ 
  ...
  ## Define files containing postburnin parameter values
	ag <- paste("../02_model_fit/SPOM03/",run_name,"_alpha.gamma.txt",sep="")
	ae <- paste("../02_model_fit/SPOM03/",run_name,"_alpha.epsilon.txt",sep="")
	bg2 <- paste("../02_model_fit/SPOM03/",run_name,"_beta.gamma2.txt",sep="")
	be1 <- paste("../02_model_fit/SPOM03/",run_name,"_beta.epsilon1.txt",sep="")
	be2 <- paste("../02_model_fit/SPOM03/",run_name,"_beta.epsilon2.txt",sep="")
	be3 <- paste("../02_model_fit/SPOM03/",run_name,"_beta.epsilon3.txt",sep="")
  ...
  cat("   running",ncombinations,"parameter combinations\n")  
    ...
    metapopmodel <- function(alpha.gamma, alpha.epsilon, beta.gamma2, beta.epsilon1, beta.epsilon2, beta.epsilon3){
      # Preallocate arrays
      ...
      for (t in 2:YEARS){
        ...
        logit.gam <- alpha.gamma + beta.gamma2*consim
        ...
        logit.eps <- alpha.epsilon + beta.epsilon1*effareasim + beta.epsilon2*aqvegsim + beta.epsilon3*consim
