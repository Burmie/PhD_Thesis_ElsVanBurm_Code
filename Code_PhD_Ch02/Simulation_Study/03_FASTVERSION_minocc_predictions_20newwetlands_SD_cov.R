...
simulate_wetland_scenarios <- function (run_name){ 
  ...
  ## Define files containing postburnin parameter values
	ag <- paste("../03_model_and_fit/",run_name,"_alpha.gamma.txt",sep="")
	ae <- paste("../03_model_and_fit/",run_name,"_alpha.epsilon.txt",sep="")
	bg <- paste("../03_model_and_fit/",run_name,"_beta.gamma1.txt",sep="")
	be1 <- paste("../03_model_and_fit/",run_name,"_beta.epsilon1.txt",sep="")
	be2 <- paste("../03_model_and_fit/",run_name,"_beta.epsilon2.txt",sep="")
	be3 <- paste("../03_model_and_fit/",run_name,"_beta.epsilon3.txt",sep="")
  
  ## Load parameter combinations
  alpha.gamma <- read.table(ag, header = T, sep=",")[,2]
  alpha.epsilon <- read.table(ae, header = T, sep=",")[,2]
  beta.gamma1 <- read.table(bg, header = T, sep=",")[,2]
  ...
  for (condition in names.conditions) {
    ...
    effareasim <- scale(c(5.360669453, 5.871327269, 6.135450711, 5.345168107, 5.119908918, 
    ...
    aqvegsim <- scale(c(75.000, 78.333, 35.333, 23.333, 56.667, 35.333, 35.333, 23.333, 
    ...
    if (condition == "0w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- scale(c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,0.000,0.333,3.333,0.333,0,0))
    ...
    if (condition == "1w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- scale(c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,0.000,0.333,3.333,0.333,0,0,60))
      ##x and y coordinates of site centres
    ...
    if (condition == "2w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- scale(c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,0.000,0.333,3.333,0.333,0,0,60,60))
      ##x and y coordinates of site centres
    ...
    if (condition == "3w") {
      ...
      effareasim <- scale(c(5.360669453,5.871327269,6.135450711,5.345168107,5.119908918,
                      ...
                      5.348174123))
      ##aquatic vegetation cover for each wetland
      aqvegsim <- scale(c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,0.000,0.333,3.333,0.333,0,0,60,60,60))
      ##x and y coordinates of site centres
    ...
    if (condition == "4w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- scale(c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,0.000,0.333,3.333,0.333,0,0,60,60,60,60))
      ##x and y coordinates of site centres
    ...
    if (condition == "5w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- scale(c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,
                          0.000,0.333,3.333,0.333,0,0,60,60,60,60,60))
      ##x and y coordinates of site centres
    ...
    if (condition == "6w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- scale(c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,
                          0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60))
      ##x and y coordinates of site centres
    ...
    if (condition == "7w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- scale(c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,
                          0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60))
      ##x and y coordinates of site centres
    ...
    if (condition == "8w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- scale(c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,
                          0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60,60))
      ##x and y coordinates of site centres
    ...
    if (condition == "9w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- scale(c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,
                          0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60,60,60))
      ##x and y coordinates of site centres
    ...
    metapopmodel <- function(alpha.gamma, alpha.epsilon, beta.gamma1, beta.epsilon1, beta.epsilon2, beta.epsilon3){
      ...
      for (t in 2:YEARS){
        ...
        logit.gam <- alpha.gamma + beta.gamma1*consim
