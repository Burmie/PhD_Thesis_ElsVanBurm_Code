...
simulate_wetland_scenarios <- function (run_name){ 
  ...
  load("../02_model_fit/data_6_years.Rda")
  ...
  for (condition in names.conditions) {
    ...
    ####################### CURRENT CONDITIONS #############################
    ########################################################################
    #### Set up metapopulation to be simulated ####
    ...
    effareasim <- lapply(effareasim, a)
    ...
    if (condition == "0w") {
      ...
      effareasim <- c(5.360669453,5.871327269,6.135450711,5.345168107,5.119908918,
                      5.751070282,5.542636071,3.091042453,2.898028875,5.086644042,
                      4.724211935,4.997349522,2.952680924,7.367708572,4.920772999,
                      4.196033535,2.663938084,2.585241998)
      effareasim <- lapply(effareasim, a)
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,0.000,0.333,3.333,0.333,0,0)
      aqvegsim <- lapply(aqvegsim, b)
    ...
    if (condition == "1w") {
      ...
      effareasim <- c(5.360669453,5.871327269,6.135450711,5.345168107,5.119908918,
                      5.751070282,5.542636071,3.091042453,2.898028875,5.086644042,
                      4.724211935,4.997349522,2.952680924,7.367708572,4.920772999,
                      4.196033535,2.663938084,2.585241998,5.348174123)
      effareasim <- lapply(effareasim, a)
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,0.000,0.333,3.333,0.333,0,0,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "2w") {
      ...
      effareasim <- lapply(effareasim, a)
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,0.000,0.333,3.333,0.333,0,0,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "3w") {
      ...
      effareasim <- lapply(effareasim, a)
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,0.000,0.333,3.333,0.333,0,0,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "4w") {
      ...
      effareasim <- c(5.360669453,5.871327269,6.135450711,5.345168107,5.119908918,
                      ...
                      4.724211935,4.997349522,2.952680924,7.367708572,4.920772999,
                      4.196033535,2.663938084,2.585241998,5.348174123,5.348174123,
                      5.348174123,5.348174123)
      effareasim <- lapply(effareasim, a)
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,0.000,0.333,3.333,0.333,0,0,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "5w") {
      ...
      effareasim <- c(5.360669453,5.871327269,6.135450711,5.345168107,5.119908918,
                      ...
                      4.724211935,4.997349522,2.952680924,7.367708572,4.920772999,
                      4.196033535,2.663938084,2.585241998,5.348174123,5.348174123,
                      5.348174123,5.348174123,5.348174123)
      effareasim <- lapply(effareasim, a)
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,0.000,0.333,3.333,0.333,0,0,60,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "6w") {
      ...
      effareasim <- c(5.360669453,5.871327269,6.135450711,5.345168107,5.119908918,
                      ...
                      4.724211935,4.997349522,2.952680924,7.367708572,4.920772999,
                      4.196033535,2.663938084,2.585241998,5.348174123,5.348174123,
                      5.348174123,5.348174123,5.348174123,5.348174123)
      effareasim <- lapply(effareasim, a)
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "7w") {
      ...
      effareasim <- lapply(effareasim, a)
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "8w") {
      ...
      effareasim <- lapply(effareasim, a)
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "9w") {
      ...
      effareasim <- lapply(effareasim, a)
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "10w") {
      ...
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,
                          0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "11w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,
                    0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "12w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,
                    0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60,60,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "13w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,
                    0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60,60,60,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "14w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,
                    0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60,60,60,60,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "15w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,
                          0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "16w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,
                    0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "17w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,
                    0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "18w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,
                    0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "19w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,
                    0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
    ...
    if (condition == "20w") {
      ...
      ##aquatic vegetation cover for each wetland
      aqvegsim <- c(75.000,78.333,35.333,23.333,56.667,35.333,35.333,23.333,28.667,35.333,35.333,36.667,
                    0.000,0.333,3.333,0.333,0,0,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60,60)
      aqvegsim <- lapply(aqvegsim, b)
      ##x and y coordinates of site centres
      coords <- structure(list(x = c(319745L,319825L,320076L,318829L,318914L,320298L,320449L,318824L,319181L,320629L,320871L,319139L,319739L,319807L,318679L,319367L,319379L,319412L,319857L,319914L,319961L,319865L,320019L,319869L,320072L,320109L,319250L,319280L,319300L,319350L,319400L,319380L,319600L,319600L,319650L,319660L,319700L,319700L),
    ...
    metapopmodel <- function(alpha.gamma, alpha.epsilon, beta.gamma1, beta.epsilon1, beta.epsilon2, beta.epsilon3){
      ...
      for (t in 2:YEARS){
        ...
        consim[t, ] <- log(colSums(conwsim[t, , ], na.rm=TRUE) + 1)
