...
save(SC_detected_25_percent, file="SC_detected_25_percent_RESCALED_COST.Rda")
save(SC_detected_50_percent, file="SC_detected_50_percent_RESCALED_COST.Rda")
save(SC_detected_75_percent, file="SC_detected_75_percent_RESCALED_COST.Rda")
